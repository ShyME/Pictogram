-- The `likes` sub-domain owns the `likes` schema (ADR-0009). A like references a post and a
...
create index post_like_post_idx on likes.post_like (post_id);
