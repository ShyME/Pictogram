...
class RefreshCookieTest {
    ...
    void issuedCookieIsHttpOnlyStrictAndScopedToTheAuthPath() {
        String header = RefreshCookie.issue("refresh-token-abc", Duration.ofDays(30), true)
                .toString();
    ...
    void theSecureAttributeFollowsTheConfiguredFlag() {
        assertThat(RefreshCookie.issue("t", Duration.ofDays(1), false).toString())
