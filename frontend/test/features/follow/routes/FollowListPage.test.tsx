...
import { FollowListPage } from "@features/follow/routes/FollowListPage";
import type { FollowListData } from "@features/follow/model/follow-list";
import type { Account } from "@features/follow/model/account";
...
vi.mock("@features/follow/api/follow-api", () => ({
  fetchFollowListPage: (...args: unknown[]) => fetchFollowListPage(...args),
}));

vi.mock("@features/follow/components/AccountList", () => ({
