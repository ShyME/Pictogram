...
export interface paths {
    ...
    "/api/comments": {
        ...
        get: operations["countsByPostIds"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface operations {
    ...
    countsByPostIds: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PostCommentsView"][];
                };
            };
    ...
    notifications: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ApiPageNotificationView"];
                };
            };
            /** @description The pagination cursor is malformed. */
            400: {
    ...
    postsByIds: {
        ...
        requestBody?: never;
        responses: {
            /** @description The batch of posts for the ids that have one, unpaged. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
